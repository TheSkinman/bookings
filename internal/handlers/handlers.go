...
import (
	...
	"gethub.com/TheSkinman/bookings/internal/forms"
...
// Gererals renders the generals quarters room page
func (m *Repository) Generals(w http.ResponseWriter, r *http.Request) {
	render.RenderTemplate(w, r, "generals.page.tmpl", &models.TemplateData{})
}

// Majors renders the majors suiet  room page
...
// AvailabilityJSON handles request for availability and sneds JSON response
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		...
		log.Println("ReservationSummary: cannot get item from session")
